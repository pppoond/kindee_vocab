...
import { ArrowLeft, ShieldAlert, Trophy, Star, Timer, BookOpen } from "lucide-react"
...
export default function Oxford3000Game() {
  ...
  const {
    ...
    handleAnswer,
    resetGame,
  } = useGameEngine("oxford3000", onAlert)
    ...
    <div className="min-h-screen bg-background text-foreground overflow-y-auto flex flex-col">
      ...
      <div className="p-4 flex items-center justify-between z-10">
        ...
        <div className="flex items-center gap-3">
          <Badge variant="outline" className="border-blue-500/50 text-blue-400 gap-1.5 px-3 py-1 text-sm">
        ...
        <div className="w-full max-w-2xl w-[95%] z-10 px-2 sm:px-0">
          {gameState === "playing" ? (
            <>
              ...
              <div className="bg-primary/10 p-2 text-center border-b border-border">
                <Badge variant="outline" className="text-muted-foreground border-border text-[10px] md:text-xs">Choose the correct meaning</Badge>
              </div>
