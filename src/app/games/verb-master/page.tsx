      ...
      <div className="min-h-screen bg-zinc-950 text-white flex flex-col items-center justify-center p-4">
        <div className="max-w-md w-full text-center space-y-8">
          ...
          <p className="text-zinc-500 text-lg leading-relaxed">
            ทดสอบความแม่นของกริยา 3 ช่อง! <br/>
    ...
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col p-4">
      ...
      <div className="max-w-2xl mx-auto w-full flex items-center justify-between py-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className={`flex items-center gap-2 px-4 py-2 rounded-2xl border-2 transition-colors ${timeLeft < 5 ? "border-red-500/50 bg-red-500/10 text-red-400" : "border-zinc-800 bg-zinc-900"}`}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-2xl mx-auto w-full pb-20">
        <Card className={`w-full bg-zinc-900 border-2 transition-all duration-300 ${feedback === "correct" ? "border-emerald-500 shadow-[0_0_30px_rgba(16,185,129,0.2)]" : feedback === "wrong" ? "border-red-500 animate-shake shadow-[0_0_30px_rgba(239,68,68,0.2)]" : "border-zinc-800"}`}>
          <CardHeader className="text-center space-y-4 pt-10">
            <Badge variant="outline" className="text-zinc-500 border-zinc-800 px-3 py-1">Verb 1 (Present)</Badge>
            <CardTitle className="text-6xl font-black tracking-tighter text-white">{currentVerb?.word}</CardTitle>
